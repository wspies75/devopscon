...
In order to make it work, please DO NOT follow the instructions below: 

<ul>
  <li>Make sure you have JAVA 17, or 21 (<b>JDK</b> and not <b>JRE standalone</b>) running on your laptop</li>
